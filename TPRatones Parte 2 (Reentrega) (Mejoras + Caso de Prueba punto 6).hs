...
----------------------------------------------------------------
-- Por si querés probar
punto6 = laMejorMedicina [pondsAntiAge,ratisalil] (promedioDeEstudio estudioDeAntiguedad) coloniaPDP

punto6B = laMejorMedicina [pondsAntiAge] (promedioDeEstudio estudioDeMasaCorporal) coloniaPDP

-- Para el punto 4
raton1 = CRaton {edad = 88, peso = 20, altura = 0.8, enfermedades = ["disneymania","hipotermia","varicela"]}
raton2 = CRaton {edad = 76, peso = 2, altura = 0.3, enfermedades = ["tuberculosis","varicela","endemia","hipotermia"]}
coloniaB = [raton1,raton2]
